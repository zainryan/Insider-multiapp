...
static llvm::cl::OptionCategory STAccelCategory("Insider s2s transformer for the interconnect");
...
void loadTemplate() {
  std::ifstream itc_istream("/usr/insider/synthesis/template/itc_template_itc.txt",
			    std::ifstream::in);
  std::ifstream header_istream("/usr/insider/synthesis/template/itc_template_header.txt",
			       std::ifstream::in);
  std::string s;
