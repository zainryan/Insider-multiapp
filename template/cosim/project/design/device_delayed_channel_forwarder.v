...
module device_delayed_channel_forwarder (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
ap_continue,
        ...
        device_dram_write_req_data_delayed_V_last_din,
        device_dram_write_req_data_delayed_V_last_full_n,
        device_dram_write_req_data_delayed_V_last_write,
        device_dram_write_req_data_delayed_V_data_V_din,
        device_dram_write_req_data_delayed_V_data_V_full_n,
        device_dram_write_req_data_delayed_V_data_V_write,
        device_dram_read_resp_delayed_V_last_dout,
        device_dram_read_resp_delayed_V_last_empty_n,
        device_dram_read_resp_delayed_V_last_read,
        device_dram_read_resp_delayed_V_data_V_dout,
        device_dram_read_resp_delayed_V_data_V_empty_n,
        device_dram_read_resp_delayed_V_data_V_read,
...
output   device_dram_write_req_data_delayed_V_last_din;
input   device_dram_write_req_data_delayed_V_last_full_n;
output   device_dram_write_req_data_delayed_V_last_write;
output  [511:0] device_dram_write_req_data_delayed_V_data_V_din;
input   device_dram_write_req_data_delayed_V_data_V_full_n;
output   device_dram_write_req_data_delayed_V_data_V_write;
input   device_dram_read_resp_delayed_V_last_dout;
input   device_dram_read_resp_delayed_V_last_empty_n;
output   device_dram_read_resp_delayed_V_last_read;
input  [511:0] device_dram_read_resp_delayed_V_data_V_dout;
input   device_dram_read_resp_delayed_V_data_V_empty_n;
output   device_dram_read_resp_delayed_V_data_V_read;
...
reg    device_dram_read_resp_delayed_V_last0_update;
wire   [0:0] empty_n_1_nbread_fu_162_p3_0;
reg    device_dram_write_req_data_delayed_V_last1_update;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_154)) begin
        if (((ap_phi_mux_valid_read_resp_phi_fu_206_p4 == 1'd0) & (empty_n_5_fu_404_p1 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_read_resp_0_2_reg_369 <= device_dram_read_resp_delayed_V_last_dout;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_154)) begin
        if (((ap_phi_mux_valid_read_resp_phi_fu_206_p4 == 1'd0) & (empty_n_5_fu_404_p1 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_read_resp_1_2_reg_357 <= device_dram_read_resp_delayed_V_data_V_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_154)) begin
        if (((empty_n_5_fu_404_p1 == 1'd1) & (ap_phi_mux_valid_read_resp_phi_fu_206_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_tmp_data_V_2_reg_325 <= device_dram_read_resp_delayed_V_data_V_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_154)) begin
        if (((empty_n_4_fu_392_p1 == 1'd1) & (ap_phi_mux_valid_write_req_data_phi_fu_194_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_tmp_data_V_reg_258 <= device_dram_write_req_data_V_data_V_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_154)) begin
        if (((empty_n_5_fu_404_p1 == 1'd1) & (ap_phi_mux_valid_read_resp_phi_fu_206_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_tmp_last_2_reg_336 <= device_dram_read_resp_delayed_V_last_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_154)) begin
        if (((empty_n_4_fu_392_p1 == 1'd1) & (ap_phi_mux_valid_write_req_data_phi_fu_194_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_tmp_last_reg_269 <= device_dram_write_req_data_V_last_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_154)) begin
        if (((empty_n_4_fu_392_p1 == 1'd0) & (ap_phi_mux_valid_write_req_data_phi_fu_194_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_write_req_data_0_2_reg_302 <= device_dram_write_req_data_V_last_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_154)) begin
        if (((empty_n_4_fu_392_p1 == 1'd0) & (ap_phi_mux_valid_write_req_data_phi_fu_194_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_write_req_data_1_2_reg_290 <= device_dram_write_req_data_V_data_V_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & ((device_dram_read_resp_V_last_full_n & device_dram_read_resp_V_data_V_full_n) == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((valid_read_resp_reg_202 == 1'd1) | (empty_n_5_reg_460 == 1'd1)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & ((device_dram_read_resp_delayed_V_last_empty_n & device_dram_read_resp_delayed_V_data_V_empty_n) == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_phi_mux_valid_read_resp_phi_fu_206_p4 == 1'd0))) begin
        device_dram_read_resp_delayed_V_last0_update = 1'b1;
    end else begin
        device_dram_read_resp_delayed_V_last0_update = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & ((device_dram_write_req_data_V_last_empty_n & device_dram_write_req_data_V_data_V_empty_n) == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_phi_mux_valid_write_req_data_phi_fu_194_p4 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & ((device_dram_write_req_data_delayed_V_last_full_n & device_dram_write_req_data_delayed_V_data_V_full_n) == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((empty_n_4_reg_442 == 1'd1) | (valid_write_req_data_reg_190 == 1'd1)))) begin
        device_dram_write_req_data_delayed_V_last1_update = 1'b1;
    end else begin
        device_dram_write_req_data_delayed_V_last1_update = 1'b0;
    end
end
...
assign device_dram_read_resp_V_data_V_din = ap_phi_mux_tmp_data_V_2_phi_fu_328_p4;

assign device_dram_read_resp_V_data_V_write = device_dram_read_resp_V_last1_update;

assign device_dram_read_resp_V_last_din = ap_phi_mux_tmp_last_2_phi_fu_339_p4;

assign device_dram_read_resp_V_last_write = device_dram_read_resp_V_last1_update;

assign device_dram_read_resp_delayed_V_data_V_read = device_dram_read_resp_delayed_V_last0_update;

assign device_dram_read_resp_delayed_V_last_read = device_dram_read_resp_delayed_V_last0_update;
...
assign device_dram_write_req_data_delayed_V_data_V_din = ap_phi_mux_tmp_data_V_phi_fu_261_p4;

assign device_dram_write_req_data_delayed_V_data_V_write = device_dram_write_req_data_delayed_V_last1_update;

assign device_dram_write_req_data_delayed_V_last_din = ap_phi_mux_tmp_last_phi_fu_272_p4;

assign device_dram_write_req_data_delayed_V_last_write = device_dram_write_req_data_delayed_V_last1_update;

assign empty_n_1_nbread_fu_162_p3_0 = (device_dram_read_resp_delayed_V_last_empty_n & device_dram_read_resp_delayed_V_data_V_empty_n);

assign empty_n_4_fu_392_p1 = empty_n_nbread_fu_154_p3_0;

assign empty_n_5_fu_404_p1 = empty_n_1_nbread_fu_162_p3_0;

assign empty_n_nbread_fu_154_p3_0 = (device_dram_write_req_data_V_last_empty_n & device_dram_write_req_data_V_data_V_empty_n);

assign full_n_1_nbwrite_fu_180_p5 = (device_dram_read_resp_V_last_full_n & device_dram_read_resp_V_data_V_full_n);

assign full_n_nbwrite_fu_170_p5 = (device_dram_write_req_data_delayed_V_last_full_n & device_dram_write_req_data_delayed_V_data_V_full_n);
...
endmodule //device_delayed_channel_forwarder
