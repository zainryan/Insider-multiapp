...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & ((valid_read_resp_phi_fu_249_p4 == 1'd1) | (1'd1 == empty_n_5_fu_421_p1)) & (1'b1 == (device_dram_read_resp_V_last_full_n & device_dram_read_resp_V_data_V_full_n)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'd0 == valid_read_resp_phi_fu_249_p4) & (1'b1 == (device_dram_read_resp_delayed_V_last_empty_n & device_dram_read_resp_delayed_V_data_V_empty_n)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'd0 == valid_write_req_data_phi_fu_238_p4) & (1'b1 == (device_dram_write_req_data_V_last_empty_n & device_dram_write_req_data_V_data_V_empty_n)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & ((valid_write_req_data_phi_fu_238_p4 == 1'd1) | (1'd1 == empty_n_4_fu_390_p1)) & (1'b1 == (device_dram_write_req_data_delayed_V_last_full_n & device_dram_write_req_data_delayed_V_data_V_full_n)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        if (((1'd0 == valid_read_resp_phi_fu_249_p4) & (1'd0 == empty_n_5_fu_421_p1))) begin
            read_resp_0_2_phi_fu_371_p4 = device_dram_read_resp_delayed_V_last_dout;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        if (((1'd0 == valid_read_resp_phi_fu_249_p4) & (1'd0 == empty_n_5_fu_421_p1))) begin
            read_resp_1_2_phi_fu_359_p4 = device_dram_read_resp_delayed_V_data_V_dout;
        end else if (((valid_read_resp_phi_fu_249_p4 == 1'd1) | (1'd1 == empty_n_5_fu_421_p1))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        if (((1'd1 == empty_n_5_fu_421_p1) & (1'd0 == valid_read_resp_phi_fu_249_p4))) begin
            tmp_data_V_2_phi_fu_326_p4 = device_dram_read_resp_delayed_V_data_V_dout;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        if (((1'd1 == empty_n_4_fu_390_p1) & (1'd0 == valid_write_req_data_phi_fu_238_p4))) begin
            tmp_data_V_phi_fu_259_p4 = device_dram_write_req_data_V_data_V_dout;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        if (((1'd1 == empty_n_5_fu_421_p1) & (1'd0 == valid_read_resp_phi_fu_249_p4))) begin
            tmp_last_2_phi_fu_337_p4 = device_dram_read_resp_delayed_V_last_dout;
        end else if ((valid_read_resp_phi_fu_249_p4 == 1'd1)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        if (((1'd1 == empty_n_4_fu_390_p1) & (1'd0 == valid_write_req_data_phi_fu_238_p4))) begin
            tmp_last_phi_fu_270_p4 = device_dram_write_req_data_V_last_dout;
        end else if ((valid_write_req_data_phi_fu_238_p4 == 1'd1)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        if (((1'd0 == valid_write_req_data_phi_fu_238_p4) & (1'd0 == empty_n_4_fu_390_p1))) begin
            write_req_data_0_2_phi_fu_304_p4 = device_dram_write_req_data_V_last_dout;
        end else if (((valid_write_req_data_phi_fu_238_p4 == 1'd1) | (1'd1 == empty_n_4_fu_390_p1))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        if (((1'd0 == valid_write_req_data_phi_fu_238_p4) & (1'd0 == empty_n_4_fu_390_p1))) begin
            write_req_data_1_2_phi_fu_292_p4 = device_dram_write_req_data_V_data_V_dout;
        end else if (((valid_write_req_data_phi_fu_238_p4 == 1'd1) | (1'd1 == empty_n_4_fu_390_p1))) begin
...
assign device_dram_read_resp_V_data_V_din = tmp_data_V_2_phi_fu_326_p4;

assign device_dram_read_resp_V_data_V_write = device_dram_read_resp_V_last1_update;

assign device_dram_read_resp_V_last_din = tmp_last_2_phi_fu_337_p4;
...
assign device_dram_write_req_data_delayed_V_data_V_din = tmp_data_V_phi_fu_259_p4;

assign device_dram_write_req_data_delayed_V_data_V_write = device_dram_write_req_data_delayed_V_last1_update;

assign device_dram_write_req_data_delayed_V_last_din = tmp_last_phi_fu_270_p4;

assign device_dram_write_req_data_delayed_V_last_write = device_dram_write_req_data_delayed_V_last1_update;

assign empty_n_1_nbread_fu_172_p3_0 = (device_dram_read_resp_delayed_V_last_empty_n & device_dram_read_resp_delayed_V_data_V_empty_n);
...
assign full_n_nbwrite_fu_162_p5 = (device_dram_write_req_data_delayed_V_last_full_n & device_dram_write_req_data_delayed_V_data_V_full_n);
