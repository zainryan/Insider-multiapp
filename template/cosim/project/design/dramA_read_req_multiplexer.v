...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (empty_n_2_fu_173_p1 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & ((device_dramA_read_req_V_num_empty_n & device_dramA_read_req_V_addr_empty_n) == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & ((host_dramA_read_req_V_num_empty_n & host_dramA_read_req_V_addr_empty_n) == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((dramA_read_context_V_full_n == 1'b0) & (ap_predicate_op32_write_state3 == 1'b1)) | ((dramA_read_req_V_num1_status == 1'b0) & (ap_predicate_op32_write_state3 == 1'b1)) | ((empty_n_2_reg_197 == 1'd1) & (dramA_read_context_V_full_n == 1'b0)) | ((empty_n_2_reg_197 == 1'd1) & (dramA_read_req_V_num1_status == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((dramA_read_context_V_full_n == 1'b0) & (ap_predicate_op32_write_state3 == 1'b1)) | ((dramA_read_req_V_num1_status == 1'b0) & (ap_predicate_op32_write_state3 == 1'b1)) | ((empty_n_2_reg_197 == 1'd1) & (dramA_read_context_V_full_n == 1'b0)) | ((empty_n_2_reg_197 == 1'd1) & (dramA_read_req_V_num1_status == 1'b0))));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (((dramA_read_context_V_full_n == 1'b0) & (ap_predicate_op32_write_state3 == 1'b1)) | ((dramA_read_req_V_num1_status == 1'b0) & (ap_predicate_op32_write_state3 == 1'b1)) | ((empty_n_2_reg_197 == 1'd1) & (dramA_read_context_V_full_n == 1'b0)) | ((empty_n_2_reg_197 == 1'd1) & (dramA_read_req_V_num1_status == 1'b0)));
end
