...
(* CORE_GENERATION_INFO="app_pt_1,hls_ip_2017_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-2-i,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.776250,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=72,HLS_SYN_LUT=413}" *)
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_11001 == 1'b0) & (1'd0 == reset_phi_fu_217_p4))) begin
        empty_n_reg_369 <= reset_app_pt_1_V_empty_n;
    end
end
...
always @ (*) begin
    if ((ap_condition_127 == 1'b1)) begin
        if (((1'd0 == reset_phi_fu_217_p4) & (1'd1 == empty_n_fu_263_p1))) begin
            reset_1_phi_fu_228_p4 = reset_app_pt_1_V_empty_n;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_11001 == 1'b0) & (1'd0 == reset_phi_fu_217_p4) & (1'b1 == ap_enable_reg_pp0_iter0) & (1'b1 == reset_app_pt_1_V_empty_n))) begin
...
assign empty_n_fu_263_p1 = reset_app_pt_1_V_empty_n;
...
assign tmp_7_fu_274_p2 = ((state_1_fu_268_p2 == 32'd3) ? 1'b1 : 1'b0);
