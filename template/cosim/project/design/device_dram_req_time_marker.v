...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_164)) begin
        if (((ap_phi_mux_valid_write_req_apply_phi_fu_244_p4 == 1'd0) & (empty_n_5_fu_435_p1 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_p_09_0_2_reg_400 <= device_dram_write_req_apply_V_num_dout;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_164)) begin
        if (((ap_phi_mux_valid_write_req_apply_phi_fu_244_p4 == 1'd0) & (empty_n_5_fu_435_p1 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_p_09_1_2_reg_388 <= device_dram_write_req_apply_V_addr_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_164)) begin
        if (((empty_n_4_fu_423_p1 == 1'd0) & (ap_phi_mux_valid_read_req_phi_fu_232_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_p_0_0_2_reg_343 <= device_dram_read_req_V_num_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_164)) begin
        if (((empty_n_4_fu_423_p1 == 1'd0) & (ap_phi_mux_valid_read_req_phi_fu_232_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_p_0_1_2_reg_331 <= device_dram_read_req_V_addr_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_164)) begin
        if (((empty_n_4_fu_423_p1 == 1'd1) & (ap_phi_mux_valid_read_req_phi_fu_232_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_read_req_with_time_req_addr_reg_309 <= device_dram_read_req_V_addr_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_164)) begin
        if (((empty_n_4_fu_423_p1 == 1'd1) & (ap_phi_mux_valid_read_req_phi_fu_232_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_read_req_with_time_req_num_reg_320 <= device_dram_read_req_V_num_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_164)) begin
        if (((empty_n_5_fu_435_p1 == 1'd1) & (ap_phi_mux_valid_write_req_apply_phi_fu_244_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_write_req_apply_with_time_req_apply_addr_reg_366 <= device_dram_write_req_apply_V_addr_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_164)) begin
        if (((empty_n_5_fu_435_p1 == 1'd1) & (ap_phi_mux_valid_write_req_apply_phi_fu_244_p4 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_write_req_apply_with_time_req_apply_num_reg_377 <= device_dram_write_req_apply_V_num_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (*) begin
    if ((((device_dram_read_req_V_num_empty_n & device_dram_read_req_V_addr_empty_n) == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_phi_mux_valid_read_req_phi_fu_232_p4 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((((device_dram_read_req_with_time_V_time_full_n & device_dram_read_req_with_time_V_req_num_full_n & device_dram_read_req_with_time_V_req_addr_full_n) == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & ((empty_n_4_reg_467 == 1'd1) | (valid_read_req_reg_228 == 1'd1)))) begin
...
always @ (*) begin
    if ((((device_dram_write_req_apply_V_num_empty_n & device_dram_write_req_apply_V_addr_empty_n) == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_phi_mux_valid_write_req_apply_phi_fu_244_p4 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((((device_dram_write_req_apply_with_time_V_time_full_n & device_dram_write_req_apply_with_time_V_req_apply_num_full_n & device_dram_write_req_apply_with_time_V_req_apply_addr_full_n) == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & ((valid_write_req_apply_reg_240 == 1'd1) | (empty_n_5_reg_484 == 1'd1)))) begin
...
assign device_dram_read_req_with_time_V_req_addr_din = ap_phi_mux_read_req_with_time_req_addr_phi_fu_312_p4;

assign device_dram_read_req_with_time_V_req_addr_write = device_dram_read_req_with_time_V_time1_update;

assign device_dram_read_req_with_time_V_req_num_din = ap_phi_mux_read_req_with_time_req_num_phi_fu_323_p4;

assign device_dram_read_req_with_time_V_req_num_write = device_dram_read_req_with_time_V_time1_update;

assign device_dram_read_req_with_time_V_time_din = read_req_with_time_time_reg_296;
...
assign device_dram_write_req_apply_with_time_V_req_apply_addr_din = ap_phi_mux_write_req_apply_with_time_req_apply_addr_phi_fu_369_p4;

assign device_dram_write_req_apply_with_time_V_req_apply_addr_write = device_dram_write_req_apply_with_time_V_time1_update;

assign device_dram_write_req_apply_with_time_V_req_apply_num_din = ap_phi_mux_write_req_apply_with_time_req_apply_num_phi_fu_380_p4;

assign device_dram_write_req_apply_with_time_V_req_apply_num_write = device_dram_write_req_apply_with_time_V_time1_update;

assign device_dram_write_req_apply_with_time_V_time_din = read_req_with_time_time_reg_296;

assign device_dram_write_req_apply_with_time_V_time_write = device_dram_write_req_apply_with_time_V_time1_update;

assign empty_n_1_nbread_fu_194_p3_0 = (device_dram_write_req_apply_V_num_empty_n & device_dram_write_req_apply_V_addr_empty_n);
...
assign full_n_1_nbwrite_fu_215_p7 = (device_dram_write_req_apply_with_time_V_time_full_n & device_dram_write_req_apply_with_time_V_req_apply_num_full_n & device_dram_write_req_apply_with_time_V_req_apply_addr_full_n);

assign full_n_nbwrite_fu_202_p7 = (device_dram_read_req_with_time_V_time_full_n & device_dram_read_req_with_time_V_req_num_full_n & device_dram_read_req_with_time_V_req_addr_full_n);
