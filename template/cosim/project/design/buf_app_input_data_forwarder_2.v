...
(* CORE_GENERATION_INFO="buf_app_input_data_forwarder_2,hls_ip_2017_4_op,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-2-i,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.678250,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1595,HLS_SYN_LUT=255}" *)

module buf_app_input_data_forwarder_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
endmodule //buf_app_input_data_forwarder_2
