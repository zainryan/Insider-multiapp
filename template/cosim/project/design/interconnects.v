...
(* CORE_GENERATION_INFO="interconnects,hls_ip_2017_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-2-i,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.188000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=889,HLS_SYN_LUT=6345}" *)
...
wire    keeper_pcie_read_resp_U0_start_full_n;
...
wire    host_dram_delay_unit_U0_start_full_n;
...
wire    host_dram_throttle_unit_U0_start_full_n;
...
wire    device_dram_delay_unit_U0_start_full_n;
...
wire    device_dram_throttle_unit_U0_start_full_n;
...
wire    dram_helper_app_0_U0_start_full_n;
...
wire    dram_helper_app_1_U0_start_full_n;
...
wire    dram_helper_app_2_U0_start_full_n;
...
wire    ap_sync_done;
reg    ap_reg_pcie_write_multiplexer_U0_ap_done;
reg    ap_reg_pcie_read_req_mux_U0_ap_done;
wire    ap_sync_ready;
...
#0 ap_reg_pcie_write_multiplexer_U0_ap_done = 1'b0;
#0 ap_reg_pcie_read_req_mux_U0_ap_done = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_reg_pcie_read_req_mux_U0_ap_done <= 1'b0;
    end else begin
        if ((1'b1 == ap_sync_done)) begin
            ap_reg_pcie_read_req_mux_U0_ap_done <= 1'b0;
        end else begin
            ap_reg_pcie_read_req_mux_U0_ap_done <= (pcie_read_req_mux_U0_ap_done | ap_reg_pcie_read_req_mux_U0_ap_done);
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_reg_pcie_write_multiplexer_U0_ap_done <= 1'b0;
    end else begin
        if ((1'b1 == ap_sync_done)) begin
            ap_reg_pcie_write_multiplexer_U0_ap_done <= 1'b0;
        end else begin
            ap_reg_pcie_write_multiplexer_U0_ap_done <= (pcie_write_multiplexer_U0_ap_done | ap_reg_pcie_write_multiplexer_U0_ap_done);
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sync_ready) & (1'b0 == command_handler_U0_ap_ready))) begin
        command_handler_U0_ap_ready_count <= (command_handler_U0_ap_ready_count - 2'd1);
    end else if (((1'b0 == ap_sync_ready) & (1'b1 == command_handler_U0_ap_ready))) begin
        command_handler_U0_ap_ready_count <= (command_handler_U0_ap_ready_count + 2'd1);
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == keeper_pcie_read_resp_U0_ap_ready) & (1'b1 == ap_sync_ready))) begin
        keeper_pcie_read_resp_U0_ap_ready_count <= (keeper_pcie_read_resp_U0_ap_ready_count - 2'd1);
    end else if (((keeper_pcie_read_resp_U0_ap_ready == 1'b1) & (1'b0 == ap_sync_ready))) begin
        keeper_pcie_read_resp_U0_ap_ready_count <= (keeper_pcie_read_resp_U0_ap_ready_count + 2'd1);
    end
end
...
assign ap_idle = (keeper_pcie_read_resp_U0_ap_idle & pipe0_data_handler_U0_ap_idle & pipe1_data_handler_U0_ap_idle & pipe2_data_handler_U0_ap_idle & command_handler_U0_ap_idle & pcie_write_multiplexer_U0_ap_idle & device_dram_read_req_multiplexer_U0_ap_idle & device_dram_read_resp_multiplexer_U0_ap_idle & pcie_read_req_mux_U0_ap_idle & pcie_read_resp_mux_U0_ap_idle & pcie_read_context_forwarder_U0_ap_idle & pipeline_data_passer_U0_ap_idle & host_dram_req_time_marker_U0_ap_idle & host_dram_delay_unit_U0_ap_idle & host_delayed_channel_forwarder_U0_ap_idle & host_dram_throttle_unit_U0_ap_idle & host_pipe0_dram_dispatcher_U0_ap_idle & host_pipe1_dram_dispatcher_U0_ap_idle & device_dram_req_time_marker_U0_ap_idle & device_dram_delay_unit_U0_ap_idle & device_delayed_channel_forwarder_U0_ap_idle & device_dram_throttle_unit_U0_ap_idle & device_pipe0_dram_dispatcher_U0_ap_idle & device_pipe1_dram_dispatcher_U0_ap_idle & dramA_write_multiplexer_U0_ap_idle & dramB_write_multiplexer_U0_ap_idle & dramC_write_multiplexer_U0_ap_idle & dramD_write_multiplexer_U0_ap_idle & dramA_read_req_multiplexer_U0_ap_idle & dramB_read_req_multiplexer_U0_ap_idle & dramC_read_req_multiplexer_U0_ap_idle & dramD_read_req_multiplexer_U0_ap_idle & dramA_read_resp_multiplexer_U0_ap_idle & dramB_read_resp_multiplexer_U0_ap_idle & dramC_read_resp_multiplexer_U0_ap_idle & dramD_read_resp_multiplexer_U0_ap_idle & unused_channel_preserver_U0_ap_idle & dram_helper_app_0_U0_ap_idle & dram_helper_app_1_U0_ap_idle & dram_helper_app_2_U0_ap_idle & buf_app_input_data_forwarder_0_U0_ap_idle & buf_app_input_data_forwarder_1_U0_ap_idle & buf_app_input_data_forwarder_2_U0_ap_idle & pcie_helper_app_0_U0_ap_idle & pcie_data_splitter_app_0_U0_ap_idle & pcie_helper_app_1_U0_ap_idle & pcie_data_splitter_app_1_U0_ap_idle & pcie_helper_app_2_U0_ap_idle & pcie_data_splitter_app_2_U0_ap_idle & reset_propaganda_U0_ap_idle & app_pt_0_U0_ap_idle & app_pt_1_U0_ap_idle & app_pt_2_U0_ap_idle);
...
assign ap_sync_done = (ap_reg_pcie_write_multiplexer_U0_ap_done & ap_reg_pcie_read_req_mux_U0_ap_done);
...
assign app_pt_0_U0_start_full_n = 1'b0;
...
assign app_pt_1_U0_start_full_n = 1'b0;
...
assign app_pt_2_U0_start_full_n = 1'b0;
...
assign buf_app_input_data_forwarder_0_U0_start_full_n = 1'b0;
...
assign buf_app_input_data_forwarder_1_U0_start_full_n = 1'b0;
...
assign buf_app_input_data_forwarder_2_U0_start_full_n = 1'b0;
...
assign command_handler_U0_ap_start = (ap_start & (ap_sync_reg_command_handler_U0_ap_ready ^ 1'b1));

assign command_handler_U0_start_full_n = (1'b0 | start_for_host_dram_delay_unit_U0_full_n | start_for_host_dram_throttle_unit_U0_full_n | start_for_device_dram_delay_unit_U0_full_n | start_for_device_dram_throttle_unit_U0_full_n | start_for_unused_channel_preserver_U0_full_n | start_for_dram_helper_app_0_U0_full_n | start_for_dram_helper_app_1_U0_full_n | start_for_dram_helper_app_2_U0_full_n | start_for_pcie_helper_app_0_U0_full_n | start_for_pcie_helper_app_1_U0_full_n | start_for_pcie_helper_app_2_U0_full_n | start_for_reset_propaganda_U0_full_n | start_for_app_pt_0_U0_full_n | start_for_app_pt_1_U0_full_n | start_for_app_pt_2_U0_full_n);
...
assign device_delayed_channel_forwarder_U0_start_full_n = 1'b0;
...
assign device_dram_delay_unit_U0_start_full_n = (1'b0 | start_for_device_pipe0_dram_dispatcher_U0_full_n);

assign device_dram_read_req_multiplexer_U0_ap_continue = 1'b1;

assign device_dram_read_req_multiplexer_U0_start_full_n = 1'b0;
...
assign device_dram_read_resp_multiplexer_U0_start_full_n = 1'b0;
...
assign device_dram_req_time_marker_U0_start_full_n = 1'b0;
...
assign device_dram_throttle_unit_U0_start_full_n = (1'b0 | start_for_device_pipe1_dram_dispatcher_U0_full_n);
...
assign device_pipe0_dram_dispatcher_U0_start_full_n = 1'b0;
...
assign device_pipe1_dram_dispatcher_U0_start_full_n = 1'b0;
...
assign dramA_read_req_multiplexer_U0_start_full_n = 1'b0;
...
assign dramA_read_resp_multiplexer_U0_start_full_n = 1'b0;
...
assign dramA_write_multiplexer_U0_start_full_n = 1'b0;
...
assign dramB_read_req_multiplexer_U0_start_full_n = 1'b0;
...
assign dramB_read_resp_multiplexer_U0_start_full_n = 1'b0;
...
assign dramB_write_multiplexer_U0_start_full_n = 1'b0;
...
assign dramC_read_req_multiplexer_U0_start_full_n = 1'b0;
...
assign dramC_read_resp_multiplexer_U0_start_full_n = 1'b0;
...
assign dramC_write_multiplexer_U0_start_full_n = 1'b0;
...
assign dramD_read_req_multiplexer_U0_start_full_n = 1'b0;
...
assign dramD_read_resp_multiplexer_U0_start_full_n = 1'b0;
...
assign dramD_write_multiplexer_U0_start_full_n = 1'b0;
...
assign dram_helper_app_0_U0_start_full_n = (1'b0 | start_for_buf_app_input_data_forwarder_0_U0_full_n);
...
assign dram_helper_app_1_U0_start_full_n = (1'b0 | start_for_buf_app_input_data_forwarder_1_U0_full_n);
...
assign dram_helper_app_2_U0_start_full_n = (1'b0 | start_for_buf_app_input_data_forwarder_2_U0_full_n);
...
assign host_delayed_channel_forwarder_U0_start_full_n = 1'b0;
...
assign host_dram_delay_unit_U0_start_full_n = (1'b0 | start_for_host_pipe0_dram_dispatcher_U0_full_n);
...
assign host_dram_req_time_marker_U0_start_full_n = 1'b0;
...
assign host_dram_throttle_unit_U0_start_full_n = (1'b0 | start_for_host_pipe1_dram_dispatcher_U0_full_n);
...
assign host_pipe0_dram_dispatcher_U0_start_full_n = (1'b0 | start_for_dramA_write_multiplexer_U0_full_n | start_for_dramB_write_multiplexer_U0_full_n | start_for_dramC_write_multiplexer_U0_full_n | start_for_dramD_write_multiplexer_U0_full_n | start_for_dramA_read_req_multiplexer_U0_full_n | start_for_dramB_read_req_multiplexer_U0_full_n | start_for_dramC_read_req_multiplexer_U0_full_n | start_for_dramD_read_req_multiplexer_U0_full_n);
...
assign host_pipe1_dram_dispatcher_U0_start_full_n = 1'b0;
...
assign keeper_pcie_read_resp_U0_ap_start = (ap_start & (ap_sync_reg_keeper_pcie_read_resp_U0_ap_ready ^ 1'b1));

assign keeper_pcie_read_resp_U0_start_full_n = (1'b0 | start_for_pcie_read_resp_mux_U0_full_n);
...
assign pcie_data_splitter_app_0_U0_start_full_n = 1'b0;
...
assign pcie_data_splitter_app_1_U0_start_full_n = 1'b0;
...
assign pcie_data_splitter_app_2_U0_start_full_n = 1'b0;
...
assign pcie_helper_app_0_U0_start_full_n = 1'b0;
...
assign pcie_helper_app_1_U0_start_full_n = 1'b0;
...
assign pcie_helper_app_2_U0_start_full_n = 1'b0;

assign pcie_helper_app_2_U0_start_write = 1'b0;

assign pcie_read_context_forwarder_U0_ap_continue = 1'b1;

assign pcie_read_context_forwarder_U0_start_full_n = 1'b0;
...
assign pcie_read_req_mux_U0_start_full_n = 1'b0;
...
assign pcie_read_resp_mux_U0_start_full_n = (1'b0 | start_for_dramA_read_resp_multiplexer_U0_full_n | start_for_dramB_read_resp_multiplexer_U0_full_n | start_for_dramC_read_resp_multiplexer_U0_full_n | start_for_dramD_read_resp_multiplexer_U0_full_n);
...
assign pcie_write_multiplexer_U0_start_full_n = 1'b0;
...
assign pipe0_data_handler_U0_start_full_n = 1'b0;
...
assign pipe1_data_handler_U0_start_full_n = 1'b0;
...
assign pipe2_data_handler_U0_start_full_n = 1'b0;
...
assign pipeline_data_passer_U0_start_full_n = 1'b0;
...
assign reset_propaganda_U0_start_full_n = 1'b0;
...
assign unused_channel_preserver_U0_start_full_n = 1'b0;
