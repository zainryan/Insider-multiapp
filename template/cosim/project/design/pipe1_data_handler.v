...
(* CORE_GENERATION_INFO="pipe1_data_handler,hls_ip_2017_4_op,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-2-i,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.075250,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1230,HLS_SYN_LUT=312}" *)
...
reg   [0:0] ap_phi_mux_has_inflight_phi_fu_338_p4;
...
wire   [0:0] ap_phi_mux_has_inflight_1_phi_fu_349_p4;
wire   [0:0] empty_n_5_fu_437_p1;
wire   [0:0] tmp_last_2_fu_441_p1;
reg   [511:0] tmp_data_V_2_reg_518;
...
reg   [0:0] ap_phi_mux_has_inflight_8_phi_fu_361_p14;
wire   [0:0] ap_phi_reg_pp0_iter0_has_inflight_1_reg_346;
reg   [0:0] ap_phi_reg_pp0_iter1_has_inflight_1_reg_346;
wire   [0:0] ap_phi_reg_pp0_iter1_has_inflight_8_reg_357;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_211)) begin
        if ((ap_phi_mux_has_inflight_phi_fu_338_p4 == 1'd1)) begin
            ap_phi_reg_pp0_iter1_has_inflight_1_reg_346 <= ap_phi_mux_has_inflight_phi_fu_338_p4;
        end else if ((ap_phi_mux_has_inflight_phi_fu_338_p4 == 1'd0)) begin
            ap_phi_reg_pp0_iter1_has_inflight_1_reg_346 <= empty_n_3_nbread_fu_270_p5_0;
        end else if ((1'b1 == 1'b1)) begin
            ap_phi_reg_pp0_iter1_has_inflight_1_reg_346 <= ap_phi_reg_pp0_iter0_has_inflight_1_reg_346;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        has_inflight_reg_334 <= ap_phi_mux_has_inflight_8_phi_fu_361_p14;
    end else if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd1) & (tmp_rw_load_load_fu_434_p1 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_rw_load_load_fu_434_p1 == 1'd0) & (ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        empty_n_5_reg_509 <= empty_n_1_nbread_fu_282_p3_0;
        tmp_data_V_2_reg_518 <= host_dram_read_resp_V_data_V_dout;
        tmp_last_2_reg_513 <= host_dram_read_resp_V_last_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        has_inflight_1_reg_346 <= ap_phi_reg_pp0_iter1_has_inflight_1_reg_346;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_phi_mux_has_inflight_phi_fu_338_p4 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_rw_fu_266 <= reqs_pipe1_read_V_rw_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_rw_load_reg_505 <= tmp_rw_fu_266;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_phi_mux_has_inflight_phi_fu_338_p4 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((has_inflight_reg_334 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((((empty_n_4_fu_449_p1 == 1'd0) & (ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd1) & (tmp_rw_load_load_fu_434_p1 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((tmp_last_fu_453_p1 == 1'd0) & (empty_n_4_fu_449_p1 == 1'd1) & (ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd1) & (tmp_rw_load_load_fu_434_p1 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((empty_n_5_fu_437_p1 == 1'd0) & (tmp_rw_load_load_fu_434_p1 == 1'd0) & (ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((tmp_last_2_fu_441_p1 == 1'd0) & (tmp_rw_load_load_fu_434_p1 == 1'd0) & (empty_n_5_fu_437_p1 == 1'd1) & (ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        ap_phi_mux_has_inflight_8_phi_fu_361_p14 = 1'd1;
    end else if (((ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_mux_has_inflight_8_phi_fu_361_p14 = ap_phi_reg_pp0_iter1_has_inflight_1_reg_346;
    end else if ((((tmp_last_fu_453_p1 == 1'd1) & (empty_n_4_fu_449_p1 == 1'd1) & (ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd1) & (tmp_rw_load_load_fu_434_p1 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((tmp_rw_load_load_fu_434_p1 == 1'd0) & (tmp_last_2_fu_441_p1 == 1'd1) & (empty_n_5_fu_437_p1 == 1'd1) & (ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        ap_phi_mux_has_inflight_8_phi_fu_361_p14 = 1'd0;
    end else begin
        ap_phi_mux_has_inflight_8_phi_fu_361_p14 = ap_phi_reg_pp0_iter1_has_inflight_8_reg_357;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_mux_has_inflight_phi_fu_338_p4 = ap_phi_mux_has_inflight_8_phi_fu_361_p14;
    end else begin
        ap_phi_mux_has_inflight_phi_fu_338_p4 = has_inflight_reg_334;
    end
end

always @ (*) begin
    if (((ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd1) & (tmp_rw_load_load_fu_434_p1 == 1'd1) & ((buffered_pcie_read_resp_V_last_empty_n & buffered_pcie_read_resp_V_data_V_empty_n) == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((((tmp_rw_load_reg_505 == 1'd0) & (empty_n_5_reg_509 == 1'd1) & (has_inflight_1_reg_346 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((tmp_rw_load_reg_505 == 1'd1) & (empty_n_4_reg_523 == 1'd1) & (has_inflight_1_reg_346 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        if ((ap_predicate_op81_write_state4 == 1'b1)) begin
            data_pipe1_write_V_data_V_din = tmp_data_V_reg_532;
        end else if ((ap_predicate_op75_write_state4 == 1'b1)) begin
            data_pipe1_write_V_data_V_din = tmp_data_V_2_reg_518;
        end else begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (ap_predicate_op81_write_state4 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (ap_predicate_op75_write_state4 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        if ((ap_predicate_op81_write_state4 == 1'b1)) begin
            ...
            data_pipe1_write_V_last_din = tmp_last_2_reg_513;
        end else begin
...
always @ (*) begin
    if ((((tmp_rw_load_reg_505 == 1'd0) & (empty_n_5_reg_509 == 1'd1) & (tmp_last_2_reg_513 == 1'd1) & (has_inflight_1_reg_346 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((tmp_rw_load_reg_505 == 1'd1) & (tmp_last_reg_527 == 1'd1) & (empty_n_4_reg_523 == 1'd1) & (has_inflight_1_reg_346 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (ap_predicate_op85_write_state4 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (ap_predicate_op79_write_state4 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    if (((tmp_rw_load_load_fu_434_p1 == 1'd0) & (ap_phi_mux_has_inflight_1_phi_fu_349_p4 == 1'd1) & ((host_dram_read_resp_V_last_empty_n & host_dram_read_resp_V_data_V_empty_n) == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((ap_phi_mux_has_inflight_phi_fu_338_p4 == 1'd0) & (1'b1 == ap_condition_263) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter2 == 1'b1) & (((data_valid_pipe1_write_V_full_n == 1'b0) & (ap_predicate_op85_write_state4 == 1'b1)) | ((data_valid_pipe1_write_V_full_n == 1'b0) & (ap_predicate_op79_write_state4 == 1'b1)) | ((reqs_pipe1_write_V_rw1_status == 1'b0) & (ap_predicate_op85_write_state4 == 1'b1)) | ((reqs_pipe1_write_V_rw1_status == 1'b0) & (ap_predicate_op79_write_state4 == 1'b1)) | ((data_pipe1_write_V_last1_status == 1'b0) & (ap_predicate_op81_write_state4 == 1'b1)) | ((data_pipe1_write_V_last1_status == 1'b0) & (ap_predicate_op75_write_state4 == 1'b1))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter2 == 1'b1) & (((data_valid_pipe1_write_V_full_n == 1'b0) & (ap_predicate_op85_write_state4 == 1'b1)) | ((data_valid_pipe1_write_V_full_n == 1'b0) & (ap_predicate_op79_write_state4 == 1'b1)) | ((reqs_pipe1_write_V_rw1_status == 1'b0) & (ap_predicate_op85_write_state4 == 1'b1)) | ((reqs_pipe1_write_V_rw1_status == 1'b0) & (ap_predicate_op79_write_state4 == 1'b1)) | ((data_pipe1_write_V_last1_status == 1'b0) & (ap_predicate_op81_write_state4 == 1'b1)) | ((data_pipe1_write_V_last1_status == 1'b0) & (ap_predicate_op75_write_state4 == 1'b1))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter2 == 1'b1) & (((data_valid_pipe1_write_V_full_n == 1'b0) & (ap_predicate_op85_write_state4 == 1'b1)) | ((data_valid_pipe1_write_V_full_n == 1'b0) & (ap_predicate_op79_write_state4 == 1'b1)) | ((reqs_pipe1_write_V_rw1_status == 1'b0) & (ap_predicate_op85_write_state4 == 1'b1)) | ((reqs_pipe1_write_V_rw1_status == 1'b0) & (ap_predicate_op79_write_state4 == 1'b1)) | ((data_pipe1_write_V_last1_status == 1'b0) & (ap_predicate_op81_write_state4 == 1'b1)) | ((data_pipe1_write_V_last1_status == 1'b0) & (ap_predicate_op75_write_state4 == 1'b1))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter2 = (((data_valid_pipe1_write_V_full_n == 1'b0) & (ap_predicate_op85_write_state4 == 1'b1)) | ((data_valid_pipe1_write_V_full_n == 1'b0) & (ap_predicate_op79_write_state4 == 1'b1)) | ((reqs_pipe1_write_V_rw1_status == 1'b0) & (ap_predicate_op85_write_state4 == 1'b1)) | ((reqs_pipe1_write_V_rw1_status == 1'b0) & (ap_predicate_op79_write_state4 == 1'b1)) | ((data_pipe1_write_V_last1_status == 1'b0) & (ap_predicate_op81_write_state4 == 1'b1)) | ((data_pipe1_write_V_last1_status == 1'b0) & (ap_predicate_op75_write_state4 == 1'b1)));
end

always @ (*) begin
    ap_condition_211 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001));
end

always @ (*) begin
    ap_condition_263 = ((reqs_pipe1_read_V_tag_empty_n & reqs_pipe1_read_V_sector_off_empty_n & reqs_pipe1_read_V_sector_num_empty_n & reqs_pipe1_read_V_rw_empty_n) == 1'b1);
end
...
assign ap_phi_mux_has_inflight_1_phi_fu_349_p4 = ap_phi_reg_pp0_iter1_has_inflight_1_reg_346;

assign ap_phi_reg_pp0_iter0_has_inflight_1_reg_346 = 'bx;

assign ap_phi_reg_pp0_iter1_has_inflight_8_reg_357 = 'bx;

always @ (*) begin
    ap_predicate_op75_write_state4 = ((tmp_rw_load_reg_505 == 1'd0) & (empty_n_5_reg_509 == 1'd1) & (has_inflight_1_reg_346 == 1'd1));
end

always @ (*) begin
    ap_predicate_op79_write_state4 = ((tmp_rw_load_reg_505 == 1'd0) & (empty_n_5_reg_509 == 1'd1) & (tmp_last_2_reg_513 == 1'd1) & (has_inflight_1_reg_346 == 1'd1));
end

always @ (*) begin
    ap_predicate_op81_write_state4 = ((tmp_rw_load_reg_505 == 1'd1) & (empty_n_4_reg_523 == 1'd1) & (has_inflight_1_reg_346 == 1'd1));
end

always @ (*) begin
    ap_predicate_op85_write_state4 = ((tmp_rw_load_reg_505 == 1'd1) & (tmp_last_reg_527 == 1'd1) & (empty_n_4_reg_523 == 1'd1) & (has_inflight_1_reg_346 == 1'd1));
end
...
assign empty_n_3_nbread_fu_270_p5_0 = (reqs_pipe1_read_V_tag_empty_n & reqs_pipe1_read_V_sector_off_empty_n & reqs_pipe1_read_V_sector_num_empty_n & reqs_pipe1_read_V_rw_empty_n);
...
assign reqs_pipe1_write_V_rw1_status = (reqs_pipe1_write_V_tag_full_n & reqs_pipe1_write_V_sector_off_full_n & reqs_pipe1_write_V_sector_num_full_n & reqs_pipe1_write_V_rw_full_n);
...
assign tmp_last_2_fu_441_p1 = host_dram_read_resp_V_last_dout;
