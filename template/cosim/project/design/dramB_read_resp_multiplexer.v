...
always @ (*) begin
    if ((1'b1 == ap_condition_145)) begin
        if ((ap_phi_mux_valid_state_phi_fu_200_p4 == 1'd1)) begin
            ...
            ap_phi_mux_valid_state_1_phi_fu_211_p4 = dramB_read_context_V_empty_n;
        end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_phi_mux_valid_state_phi_fu_200_p4 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (dramB_read_context_V_empty_n == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_phi_mux_valid_read_resp_phi_fu_188_p4 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & ((dramB_read_resp_V_last_empty_n & dramB_read_resp_V_data_V_empty_n) == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter3 == 1'b1) & (((device_dramB_read_resp_V_last1_status == 1'b0) & (ap_predicate_op58_write_state5 == 1'b1)) | ((host_dramB_read_resp_V_last1_status == 1'b0) & (ap_predicate_op56_write_state5 == 1'b1))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter3 == 1'b1) & (((device_dramB_read_resp_V_last1_status == 1'b0) & (ap_predicate_op58_write_state5 == 1'b1)) | ((host_dramB_read_resp_V_last1_status == 1'b0) & (ap_predicate_op56_write_state5 == 1'b1))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter3 == 1'b1) & (((device_dramB_read_resp_V_last1_status == 1'b0) & (ap_predicate_op58_write_state5 == 1'b1)) | ((host_dramB_read_resp_V_last1_status == 1'b0) & (ap_predicate_op56_write_state5 == 1'b1))));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter3 = (((device_dramB_read_resp_V_last1_status == 1'b0) & (ap_predicate_op58_write_state5 == 1'b1)) | ((host_dramB_read_resp_V_last1_status == 1'b0) & (ap_predicate_op56_write_state5 == 1'b1)));
end
