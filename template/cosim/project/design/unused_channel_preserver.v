...
(* CORE_GENERATION_INFO="unused_channel_preserver,hls_ip_2017_4_op,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-2-i,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.458000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=5,HLS_SYN_LUT=105}" *)
...
always @ (*) begin
    if (((empty_n_reg_148 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (empty_n_reg_148 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (preserver_cheat_signals_V_empty_n == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((empty_n_reg_148 == 1'd1) & (device_dram_write_req_apply_V_num1_status == 1'b0)) | ((empty_n_reg_148 == 1'd1) & (device_dram_write_req_data_V_last1_status == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((empty_n_reg_148 == 1'd1) & (device_dram_write_req_apply_V_num1_status == 1'b0)) | ((empty_n_reg_148 == 1'd1) & (device_dram_write_req_data_V_last1_status == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((empty_n_reg_148 == 1'd1) & (device_dram_write_req_apply_V_num1_status == 1'b0)) | ((empty_n_reg_148 == 1'd1) & (device_dram_write_req_data_V_last1_status == 1'b0))));
end

assign ap_block_state2_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (((empty_n_reg_148 == 1'd1) & (device_dram_write_req_apply_V_num1_status == 1'b0)) | ((empty_n_reg_148 == 1'd1) & (device_dram_write_req_data_V_last1_status == 1'b0)));
end
