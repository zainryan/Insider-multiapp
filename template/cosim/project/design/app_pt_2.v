...
(* CORE_GENERATION_INFO="app_pt_2,hls_ip_2017_4_op,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-2-i,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.997000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=602,HLS_SYN_LUT=386}" *)
...
always @ (posedge ap_clk) begin
    if (((ap_phi_mux_reset_phi_fu_206_p4 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        empty_n_3_reg_359 <= reset_app_pt_2_V_empty_n;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_135)) begin
        if (((empty_n_3_fu_252_p1 == 1'd1) & (ap_phi_mux_reset_phi_fu_206_p4 == 1'd0))) begin
            ap_phi_mux_reset_1_phi_fu_217_p4 = reset_app_pt_2_V_empty_n;
...
always @ (*) begin
    if (((ap_phi_mux_reset_phi_fu_206_p4 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (reset_app_pt_2_V_empty_n == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
assign empty_n_3_fu_252_p1 = reset_app_pt_2_V_empty_n;
...
assign tmp_7_fu_263_p2 = ((state_1_fu_257_p2 == 32'd4) ? 1'b1 : 1'b0);
