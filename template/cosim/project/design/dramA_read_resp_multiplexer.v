...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_11001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'd0 == valid_state_phi_fu_200_p4) & (1'b1 == dramA_read_context_V_empty_n))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_11001 == 1'b0) & (1'd0 == valid_read_resp_phi_fu_188_p4) & (1'b1 == ap_enable_reg_pp0_iter0) & (1'b1 == (dramA_read_resp_V_last_empty_n & dramA_read_resp_V_data_V_empty_n)))) begin
...
always @ (*) begin
    if ((ap_condition_145 == 1'b1)) begin
        if ((1'd1 == valid_state_phi_fu_200_p4)) begin
            ...
            valid_state_1_phi_fu_211_p4 = dramA_read_context_V_empty_n;
        end else begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((1'b1 == ap_enable_reg_pp0_iter3) & (((1'b0 == host_dramA_read_resp_V_last1_status) & (1'b1 == ap_predicate_op56_write_state5)) | ((1'b0 == device_dramA_read_resp_V_last1_status) & (1'b1 == ap_predicate_op58_write_state5))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((1'b1 == ap_enable_reg_pp0_iter3) & (((1'b0 == host_dramA_read_resp_V_last1_status) & (1'b1 == ap_predicate_op56_write_state5)) | ((1'b0 == device_dramA_read_resp_V_last1_status) & (1'b1 == ap_predicate_op58_write_state5))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((1'b1 == ap_enable_reg_pp0_iter3) & (((1'b0 == host_dramA_read_resp_V_last1_status) & (1'b1 == ap_predicate_op56_write_state5)) | ((1'b0 == device_dramA_read_resp_V_last1_status) & (1'b1 == ap_predicate_op58_write_state5))));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter3 = (((1'b0 == host_dramA_read_resp_V_last1_status) & (1'b1 == ap_predicate_op56_write_state5)) | ((1'b0 == device_dramA_read_resp_V_last1_status) & (1'b1 == ap_predicate_op58_write_state5)));
end
