...
#pragma HLS pipeline
	...
	(valid_read_req_with_time = host_dram_read_req_with_time.read_nb(read_req_with_time))) {
	...
	(valid_write_req_apply_with_time = host_dram_write_req_apply_with_time.read_nb(write_req_apply_with_time))) {
      if (write_req_apply_with_time.time + delay_cycle_cnt <= time || 
	  write_req_apply_with_time.time > time) {
	if (host_dram_write_req_apply_delayed.write_nb(write_req_apply_with_time.req_apply)) {
