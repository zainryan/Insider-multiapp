#ifndef BUF_APP_INPUT_DATA_FORWARDER_0_CPP_
#define BUF_APP_INPUT_DATA_FORWARDER_0_CPP_

#include <insider_kernel.h>

void buf_app_input_data_forwarder_0(
...
#pragma HLS pipeline
    bool dummy;
    if (reset || (reset = reset_buf_app_input_data_forwarder_0.read_nb(dummy))) {
      APP_Data dummy0;
