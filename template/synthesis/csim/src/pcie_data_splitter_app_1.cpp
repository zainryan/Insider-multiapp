#ifndef PCIE_DATA_SPLITTER_APP_1_CPP_
#define PCIE_DATA_SPLITTER_APP_1_CPP_
...
#pragma HLS pipeline
	...
	if (num == (PCIE_WRITE_BATCH_NUM << DATA_BUS_WIDTH_LOG2) || app_data.eop) {
